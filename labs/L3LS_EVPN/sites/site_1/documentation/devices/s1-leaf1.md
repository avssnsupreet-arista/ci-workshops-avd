...
ntp server 192.168.0.3 prefer iburst
```
...
username arista ssh-key ssh-rsa  arista@ps-test-1-2aa8e378-eos
```
...
| --------- | --- | ---------- | ------------------ | ------------------------- | ------ | ------- |
| Vlan10 |  OVERLAY  |  -  |  10.10.10.2/24  |  -  |  -  |  -  |
| Vlan20 |  OVERLAY  |  -  |  10.20.20.2/24  |  -  |  -  |  -  |
...
interface Vlan10
   ...
   no shutdown
   vrf OVERLAY
   ip address virtual 10.10.10.2/24
!
interface Vlan20
   description Twenty
   no shutdown
   vrf OVERLAY
   ip address virtual 10.20.20.2/24
!
interface Vlan3009
